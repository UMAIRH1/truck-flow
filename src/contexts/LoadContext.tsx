...
const mockLoads: Load[] = [
  ...
  {
    id: "L009",
    pickupLocation: "15 Main St.",
    dropoffLocation: "45 Industrial Blvd.",
    ...
    otherExpenses: 30,
    paymentTerms: 30,
    expectedPayoutDate: new Date("2026-01-25"),
    loadingDate: new Date("2025-12-26"),
    loadingTime: "09:00",
    shippingType: "FTL",
    loadWeight: 800,
    status: "pending",
    ...
    updatedAt: new Date("2025-12-22"),
    timeline: [
      { status: "Load created", date: new Date("2025-12-22T10:00:00"), description: "", completed: true },
      { status: "Waiting for driver assignment", date: new Date("2025-12-22T11:00:00"), description: "", completed: false },
    ],
  },
  {
    id: "L010",
    pickupLocation: "789 Warehouse Ave.",
    dropoffLocation: "321 Distribution Center",
    ...
    otherExpenses: 25,
    paymentTerms: 45,
    expectedPayoutDate: new Date("2026-02-10"),
    loadingDate: new Date("2025-12-27"),
    loadingTime: "14:00",
    shippingType: "LTL",
    loadWeight: 600,
    status: "pending",
    ...
    timeline: [
      { status: "Load created", date: new Date("2025-12-23T08:00:00"), description: "", completed: true },
      { status: "Waiting for driver assignment", date: new Date("2025-12-23T09:00:00"), description: "", completed: false },
    ],
  },
  {
    id: "L011",
    pickupLocation: "567 Commerce Dr.",
    dropoffLocation: "890 Business Park",
    ...
    otherExpenses: 40,
    paymentTerms: 30,
    expectedPayoutDate: new Date("2026-01-30"),
    loadingDate: new Date("2025-12-28"),
    loadingTime: "07:00",
    shippingType: "FTL",
    loadWeight: 1200,
    status: "pending",
    ...
    timeline: [
      { status: "Load created", date: new Date("2025-12-24T14:00:00"), description: "", completed: true },
      { status: "Waiting for driver assignment", date: new Date("2025-12-24T15:00:00"), description: "", completed: false },
    ],
  },
  {
    id: "L012",
    pickupLocation: "123 Factory Rd.",
    dropoffLocation: "456 Retail Center",
    clientName: "Metro Distributors",
    clientPrice: 950,
    driverPrice: 650,
    fuel: 50,
    tolls: 20,
    otherExpenses: 15,
    paymentTerms: 60,
    expectedPayoutDate: new Date("2026-02-25"),
    loadingDate: new Date("2025-12-29"),
    loadingTime: "16:00",
    shippingType: "Partial",
    loadWeight: 450,
    status: "pending",
    ...
    timeline: [
      { status: "Load created", date: new Date("2025-12-25T11:00:00"), description: "", completed: true },
      { status: "Waiting for driver assignment", date: new Date("2025-12-25T12:00:00"), description: "", completed: false },
    ],
  },
];
