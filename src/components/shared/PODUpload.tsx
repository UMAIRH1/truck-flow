      ...
      {images.length < maxImages && (
        ...
        >
          ...
          <p className="text-sm text-gray-500 mb-4">
            Drag & drop images or use buttons below
          </p>
          ...
          <div className="flex gap-2 justify-center">
            <button
              type="button"
              onClick={openCamera}
              className="flex items-center gap-2 px-4 py-2 bg-yellow-400 rounded-full text-sm font-medium hover:bg-yellow-500 transition-colors"
            >
